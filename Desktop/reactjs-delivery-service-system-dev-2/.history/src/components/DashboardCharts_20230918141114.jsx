...
const DashboardCharts = ({ username }) => {
  ...
  const finalTotalProfit = firstProfitAdded.length > 0 && firstProfitAdded.filter(x => x !== false);
  useEffect(() => {
    console.log(finalTotalProfit)
  }, [])
  return (
    <div className="dashboard">
      <div className="h2">
        ...
        <InfoCard title="Total Profits" value={"$" + finalTotalProfit} icon="fa fa-money" color="#27ae60" />
      </div>
        </div>
