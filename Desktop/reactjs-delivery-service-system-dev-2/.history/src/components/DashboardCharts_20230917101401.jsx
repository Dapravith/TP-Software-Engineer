...
const DashboardCharts = ({ username }) => {
  const deliveries = [
    { Package code: '0001', products: 'Laptop', costs: '$900', deliveryDate: '2023-09-15', status: 'pending' },
    { Package code: '0002', products: 'Phone', costs: '$500', deliveryDate: '2023-09-14', status: 'delivered' },
    { Package code: '0003', products: 'Camera', costs: '$700', deliveryDate: '2023-09-13', status: 'returned' },
    { Package code: '0004', products: 'Headphones', costs: '$200', deliveryDate: '2023-09-12', status: 'pending' },
  ];
  return (
