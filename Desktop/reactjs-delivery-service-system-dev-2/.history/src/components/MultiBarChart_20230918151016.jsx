    ...
    plugins: {
      ...
      datalabels: { // Configuration for datalabels plugin
        ...
        formatter: (value, context) => {
          return `${value}%`; // Display value as a percentage
        }
      },
      tooltip: { // Configuration for tooltips
        callbacks: {
          label: (tooltipItem) => {
            return `${tooltipItem.dataset.label}: ${tooltipItem.formattedValue}%`; // Modify tooltip to show percentages
          }
        }
      }
    },
  ...
  return (
    <div className="container">
      <div className="grouped-bar-chart">
        <h3 styles="text-align: center, justify-content: center;">View Total Profits</h3>
