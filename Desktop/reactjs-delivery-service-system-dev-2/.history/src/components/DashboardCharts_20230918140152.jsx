  ...
  return (
    <div className="dashboard">
      <div className="h2">
        ...
        <InfoCard title="Total Profits" value={"$" + totalProfit.length > 0 && totalProfit.map(data => data.length > 0 && data.reduce((a, b) => a + b)).reduce((a, b) => a + b)} icon="fa fa-money" color="#27ae60" />
      </div>
        </div>
