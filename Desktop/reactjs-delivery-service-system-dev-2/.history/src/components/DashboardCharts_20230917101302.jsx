...
const DashboardCharts = ({ username }) => {
  const deliveries = [
    { Pacode: 'C123', products: 'Laptop', costs: '$900', deliveryDate: '2023-09-15', status: 'pending' },
    { code: 'C124', products: 'Phone', costs: '$500', deliveryDate: '2023-09-14', status: 'delivered' },
    { code: 'C125', products: 'Camera', costs: '$700', deliveryDate: '2023-09-13', status: 'returned' },
    { code: 'C126', products: 'Headphones', costs: '$200', deliveryDate: '2023-09-12', status: 'pending' },
  ];
  return (
