    ...
    <div className="dashboard">
      ...
      <div className="info-card-container">
        ...
        <div className="info-cards">
         <div className="info-card-container">
        <InfoCard title="Total Branch Owner" value={10} icon="fa fa-user" />
        <InfoCard title="Items" value={150} icon="fa fa-shopping-bag" />
        <InfoCard title="Incoming Items" value={30} icon="fa fa-arrow-down" />
        <InfoCard title="Pending Items" value={5} icon="fa fa-clock" />
        <InfoCard title="Delivered Items" value={115} icon="fa fa-truck" />
        <InfoCard title="Total Profits" value={240} icon="fa fa-money"  />
      </div>
