<template>
  <v-card color="#202022" class="rounded-lg mt-n3 pb-1" flat>
    <v-toolbar flat color="transparent">
      <v-toolbar-title class="white--text mt-n2">Check your Credit Cards</v-toolbar-title>
    </v-toolbar>
    <v-card
      color="#242426"
    ...
    >
      ...
      <h2 class="white--text ml-4">$28999999,85</h2>

      <v-card-text class="pt-0 mt-4">
        <span class="white--text font-weight-light">**** **** **** 8678</span>
      </v-card-text>
    </v-card>
    ...
    <v-card
      ...
      flat
    >
      <h2 class="white--text ml-4">Premium Kit Subscription</h2>
