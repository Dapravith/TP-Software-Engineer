...
function BranchOwnerDashboard() {
    ...
    console.log("Raw date value:", timestamp);
    console.log("Type of date value:", typeof timestamp);
    ...
    return `${date.getDate()}/${date.getMonth() + 1}/${date.getFullYear()} ${formattedHours}:${minutes < 10 ? '0' + minutes : minutes} ${period}`;
}
    useEffect(() => {
